...
from akangatu.transf.mixin.config import asUnitset, asConfigLess
from akangatu.transf.mixin.noop import asNoOp


class NoOp(asNoOp, asConfigLess, asUnitset, DataIndependentStep_):
    def _process_(self, data):
        return data

    # def _context_(self):
    #     return "akangatu.transf.noop"
